<?php
    class User {
        ...
        public function __construct($con, $user){
            $this->con = $con;
            $user_details = mysqli_query($con, "SELECT * FROM users WHERE username='$user'");
        ...
        public function didReceiveRequest($user_from){
            ...
            $check_request = mysqli_query($this->con, "SELECT * FROM friend_requests WHERE user_to='$user_to' AND user_from='$user_from'");
        ...
        public function removeFriend($user_to_remove){
            ...
            $remove_friend = mysqli_query($this->con, "UPDATE users SET friend_array='$new_friend_array' WHERE username='$loggedin_user'");
